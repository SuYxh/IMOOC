...
这是非常好的一门入门正则表达式的课程，但是总感觉少了点什么。后来想了想，少的东西应该是一些案例的训练，为此我额外写了篇博文，以此来更好的学习和进阶JavaScript正则表达式<br>
...
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/ProgressBar/Demo1.html)
...
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/ProgressBar/Demo2.html)

#### Demo3通过CSS3制作进度条
利用CSS3动画制作的进度条效果，简单好玩，同样也是通过加载状态来触发相应的事件。<br>
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/ProgressBar/Demo3.html)

#### Demo4固定在头部的进度条
在每一段结构代码后面添加jQuery中的animate方法增加固定在顶部元素的长度，当长度达100%后触发事件，隐藏遮罩层，这也是一种伪加载完毕事件，实用性并不强。<br>
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/ProgressBar/Demo4.html)
...
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/ProgressBar/Demo5.html)<br><br>


# 3、DelaBlog => [CSS3扁平化博客之文章页及常用组件](https://www.imooc.com/learn/598)

该课程是一个系列的，之前的源码和分析在这里——[《HTML5和CSS3扁平化风格博客》](https://github.com/SuYxh/IMOOC/tree/master/HTML_CSS)。相比于之前的课程，增加了蒙层、侧边栏弹出、回到顶部效果，以及一个博文页面。<br>
...
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/DelaBlog/index.html)<br><br>
...
针对这种情况，我基本重写了一次课程代码，大家可以结合[课程源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/Popup/demo.html)来对比，来分析。我的[JS代码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/Popup/js/index.js)也有需要改进的地方，比如将`document.getElementById()`封装成一个方法来获取HTML的DOM会使代码更加简洁和优美，在这只是给大家提个简单的思路。下面是我重写后的代码效果，与课程的效果一毛一样。<br>
[案例演示](https://suyxh.github.io/IMOOC/JavaScript/Popup/index.html)<br><br>
...
```
课程循序渐进，简洁明了的注释，让我们充分的理解了定时器，以及学会如何去使用。代码逻辑容易明白，在开发中比较常见的问题一个是this的指向问题，另外一个就是清除定时器问题。关于这两个问题老师有提到，而我也在[源码](https://github.com/SuYxh/IMOOC/tree/master/JavaScript/TabCar)中有总结了一些，有兴趣的可以去看看。<br>

由于这是一个分步讲解课程，我将代码也写成了分步，为了能够与课程同步以及方便进行分析，编程训练也摘抄了一些认为较好的贴了上来，下面是一堆的演示效果。<br>
1、[滑动、点击切换效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/index1-4.html)<br>
2、[编程练习一效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/test01.html)<br>
3、[延迟切换效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/index2-1.html)<br>
4、[JavaScript自动切换效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/index3-1.html)<br>
5、[JavaScript自动/手动切换效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/index3-2.html)<br>
6、[JavaScript自动切换代码优化效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/index3-3.html)<br>
7、[编程练习二效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/test02.html)<br>
8、[编程练习三效果](https://suyxh.github.io/IMOOC/JavaScript/TabCar/test03.html)<br><br>

# 6、BinaryTree => [JavaScript实现二叉树算法](https://www.imooc.com/learn/888)

根据该课程，我写了一篇文章，那里有比较详细的笔记，[点击我呀](https://github.com/SuYxh/IMOOC/issues/2)，由于在最后小游戏制作过程中，老师貌似少录制了一节课程，导致小游戏运行不起来。最后，我在问答区找到了一份能够跑起来的代码，并将它copy下来，[可点击这里进行查看](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/BinaryTree/index01.html?1519633599043)，可点击下方按钮查看运行效果。
[点击我呀](https://suyxh.github.io/IMOOC/JavaScript/BinaryTree/index01.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index3-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index3-1.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index3-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index3-2.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index3-4.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index3-4.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index4-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index4-3.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index4-5.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index4-5.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index4-6.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index4-6.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index4-7.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index4-7.html)<br><br>
...
接下来就是判断的传递过来option是否为一个字符串，如果是的话则执行`rating[option]();`方法，这行代码其实等同于`rating.unbindEvent()`。这样来写，是不是整个逻辑就变得清晰很多？之前思路一直卡在这里，也是不知道为什么，休息几天再仔细研究了一下代码马上就发现了奥秘的所在。下面贴课程章节的源码和演示：<br>[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index4-8.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index4-8.html)<br><br>

**8、章节5-1：**<br> 
和前面两个章节比起来，这节就十分简单了，只要修改HTML结构和CSS代码即可，看一遍视频就能懂，思路不过就是改变了图片的引用地址，没啥好说的，下面贴上课程章节的源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScore/index5-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScore/index5-1.html)<br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index1-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index1-2.html)<br><br>
...
[我是源码1](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index1-3-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index1-3-1.html)<br>
[我是源码2](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index1-3-2.html)<br>
[我是效果2](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index1-3-2.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index2-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index2-1.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index2-3html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index2-3html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index3-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index3-2.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index3-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index3-3.html)<br><br>

**7、章节3-4：** <br>
这章节的代码没啥好说的，其中的原理和实现过程前面都有提到，几乎是一毛一样的（其实就是），下面直接贴上课程章节的源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index3-4.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index3-4.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index3-5.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index3-5.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/StarScoreTwo/index3-6-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/StarScoreTwo/index3-6-2.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index2-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index2-1.html)<br><br>
...
```
var images = [{
  url: 'https://github.com/SuYxh/IMOOC/blob/master/ProImages/ImgPreloading01.jpg?raw=true',
  name: '无敌美少女一号'
}, {
  url: 'https://github.com/SuYxh/IMOOC/blob/master/ProImages/ImgPreloading02.jpg?raw=true',
  name: '无敌美少女二号'
}];
```
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index2-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index2-2.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index2-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index2-3.html)<br><br>
...
[我是结构源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index2-4.html)<br>
[我是插件源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/js/index2-4.js)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index2-4.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index3-1.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index3-1.html)<br><br>
...
下面贴课程章节的源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index3-2.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index3-2.html)<br><br>

**7、章节3-3：** <br>
这节课程代码没啥好说的，下面直接贴上课程章节的源码和演示（我没有涉H，别瞎说啊）。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index3-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index3-3.html)<br><br>
...
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index3-4.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index3-4.html)<br><br>

**9、章节4-1：** <br>
有了之前课程章节的基础，我想这节课程的代码不用解释大家也相当清楚了，下面直接贴上课程章节的源码和演示。<br>
[我是结构源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/index4-1.html)<br>
[我是插件源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/ImgPreloading/js/index4-1.js)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/ImgPreloading/index4-1.html)<br><br>
...
[章节1-3](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index1-3.html)、[章节1-4](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index1-4.html)和[章节2-2](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index2-2.html)由于都是简单的HTML与CSS代码，因此不做任何的讲解，大家点击看效果就好。<br>
...
```
下面直接贴上课程章节的源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/index2-4.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index2-4.html)<br><br>


**章节2-5和章节2-6** 其实讲到的重点就是ajax跨域的问题，由于这个自己目前也不是非常了解，所以暂时不说先，幸好的是jQuery中有解决跨域的方法，下面直接贴上2-6章节的源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/index2-6.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index2-6.html)<br><br>
...
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/2.jpg?raw=true)<br>
**步骤三：** 配置好get请求地址为(`http://api.bing.com/bing-search.html`)，点击execute，出现一个404的文件
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/3.jpg?raw=true)<br>
**步骤四：** 点击AutoResponder，再点击Enable rules和Unmatched requests passthrough，把404的文件拖到右边
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/4.jpg?raw=true)<br>
**步骤五：** 配置规则，下面一栏的文件地址为本地的文件地址，上面一栏地址为固定地址：`http://api.bing.com/bing-search.html`， 然后点击Save
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/5.jpg?raw=true)<br>
**步骤六：** 打开Chrome浏览器，输入地址：`http://api.bing.com/bing-search.html`， 假如你看到下面的场景说明已经成功一半了
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/6.jpg?raw=true)<br>
**步骤七：** 此时看看fiddler中请求页面信息，把出现404的文件如法炮制的拖到右边进行规则配置
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/7.jpg?raw=true)<br>
**步骤八：** 和步骤五一样进行规则配置，最终配置完的页面如下图
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/8.jpg?raw=true)<br>
**步骤九：** 之后我们再刷新一次页面，完美展现，输入搜索的内容也能够出现相应的结果
![](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/img/9.jpg?raw=true)<br>

如果经过上面几步还没解决问题的话，请在慕课网私信我哈。下面直接贴上2-8章节的源码。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/index2-8.html)<br>


话说[章节3-2](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-2.html)、[章节3-3](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-3.html)和[章节3-4](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-4.html)[章节3-5](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-5.html)[章节3-6](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-6.html)一样是由于都为简单的HTML与CSS代码，因此不做任何的讲解，大家点击看效果就好。不过在门课程倒是发现一篇很好的[关于BFC解读的手记](https://www.imooc.com/article/9723)，还有就是需要看源码的[请点击这里哇](https://github.com/SuYxh/IMOOC/tree/master/JavaScript/SearchFrame?1541175622979)<br>

**章节3-7** 唉，讲师太不小心，明明我是会给课程打9.9分的，因为最后一节造成了很大的bug，并且写法并不是那么优雅，所以只能说这是门不那么尽人意的课程，然而为了不让喜欢慕课网的小伙伴失望，我自己手写了一份能跑的代码，希望你们能看上眼。
下面直接贴上源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/SearchFrame/index3-7.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/SearchFrame/index3-7.html)<br><br>


# 11、ShowHidden => [展开与收起效果](https://www.imooc.com/learn/90)
相当简单的一门课程，一口气直接看完。这门课程不做什么讲解，下面直接看效果演示，部分源码含有讲解注释
- [章节2-1](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index2-1.html)
- [章节2-2](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index2-2.html)
- [章节3-1](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index3-1.html)
- [章节3-2](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index3-2.html)
- [章节4-1](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index4-1.html)
- [章节5-2](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index5-2.html)
- [章节5-3](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index5-3.html)
- [章节7-1](https://suyxh.github.io/IMOOC/JavaScript/ShowHidden/index7-1.html)<br><br>
...
```
下面直接贴上源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/PageSpecial/index4-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/PageSpecial/index4-3.html)<br><br>

### 尾声
最后几个章节使用原生JavaScript实现该定位功能，其实思路是一致的，不同的只是在写法上，在这就不详细说明了，下面直接贴上源码和演示。<br>
[我是源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/PageSpecial/index6-3.html)<br>
[我是效果](https://suyxh.github.io/IMOOC/JavaScript/PageSpecial/index6-3.html)<br><br>
...
[章节1-2源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/Countdown/index1-2.html)<br>
[章节1-2演示](https://suyxh.github.io/IMOOC/JavaScript/Countdown/index1-2.html)<br><br>
[章节2-1源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/Countdown/index2-1.html)<br>
[章节2-1演示](https://suyxh.github.io/IMOOC/JavaScript/Countdown/index2-1.html)<br><br>
[章节3-1源码](https://github.com/SuYxh/IMOOC/blob/master/JavaScript/Countdown/index3-1.html)<br>
[章节3-1演示](https://suyxh.github.io/IMOOC/JavaScript/Countdown/index3-1.html)<br><br>
